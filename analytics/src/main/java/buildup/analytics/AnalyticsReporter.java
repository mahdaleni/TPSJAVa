...
public interface AnalyticsReporter {
    AnalyticsReporter NO_OP = new AnalyticsReporter() {
        @Override
        public void init(Application app, String analyticsId, String analyticsRegion, String appName) { }
    ...
    void init(Application app, String analyticsId, String analyticsRegion, String appName);
